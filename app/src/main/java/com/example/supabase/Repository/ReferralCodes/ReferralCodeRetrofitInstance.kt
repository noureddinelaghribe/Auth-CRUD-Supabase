...
import com.example.supabase.Repository.Plan.PlanApiService
...
object ReferralCodeRetrofitInstance {
    ...
    lateinit var api: ReferralCodesApiService
    ...
    fun initialize() {
        ...
        api = retrofit!!.create(ReferralCodesApiService::class.java)
    }
}



object ReferralCodeRetrofitInstanceInsert {
