...
import com.example.supabase.Repository.History.HistoryApiService
...
object ReffrealRetrofitInstance {
    ...
    lateinit var api: ReferralsApiService
    ...
    fun initialize(context: Context) {
        ...
        api = retrofit!!.create(ReferralsApiService::class.java)
    }
}