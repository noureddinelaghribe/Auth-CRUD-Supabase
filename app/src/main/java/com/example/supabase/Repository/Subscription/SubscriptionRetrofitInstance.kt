...
import com.example.supabase.Repository.Subscription.SubscriptionRetrofitInstance
...
object SubscriptionRetrofitInstance {
    ...
    lateinit var api: SubscriptionApiService
    ...
    fun initialize(context: Context) {
        ...
        api = retrofit!!.create(SubscriptionApiService::class.java)
    }
}