...
import com.example.supabase.Repository.ReferralCodes.ReferralCodesApiService
...
object UserDeviceRetrofitInstance {
    ...
    lateinit var api: UserDevicesApiService
    ...
    fun initialize() {
        ...
        api = retrofit!!.create(UserDevicesApiService::class.java)
    }
}


object UserDeviceRetrofitInstanceInsert {
