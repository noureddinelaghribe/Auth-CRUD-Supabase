...
import com.example.supabase.Repository.Auth.AuthApiService
import com.example.supabase.Repository.Auth.AuthRetrofitInstance
import com.example.supabase.Repository.User.UserApiService
...
object SettingRetrofitInstance {
    ...
    lateinit var api: SettingApiService
    ...
    fun initialize(context: Context) {
        ...
        api = retrofit!!.create(SettingApiService::class.java)
    }
}